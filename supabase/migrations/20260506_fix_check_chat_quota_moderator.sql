-- ============================================================
-- Fix check_chat_quota: remove moderator from privileged roles
-- Aligns with prepare_chat_context where only admin/op are privileged.
-- Moderator uses proxy + subscription quota, not BYOK.
-- ============================================================
...
BEGIN
  -- Privileged roles (admin / op ONLY — moderator uses proxy + credits)
  SELECT EXISTS (
  ...
  -- Regular users (including moderator): check subscription plan
