...
JSON{
  ...
  "data": {
    ...
    "description": "[TYPE A: Physical traits, backstory, flaws (Max 150 words).] OR [TYPE B: World lore, rules, key NPCs (Max 150 words). Be concise.]",
    "personality": "[TYPE A: Core psychology, traits, attitude towards {{user}}.] OR [TYPE B: World atmosphere, GM style, NPC reaction logic.] (Use brief keywords or bullet points. Max 50 words.)",
    "scenario": "[1-2 short sentences establishing the immediate opening scene.]",
    "first_mes": "[Immersive opening using (Thought)->**Action**->\"Dialogue\" format. TYPE A: Character's first interaction. TYPE B: GM sets scene & prompts {{user}}. Keep it under 3 short comps.]",
    "mes_example": "<START>\n{{user}}: [Sample Action/Speech]\n{{char}}: [Sample Response from Character or GM. Max 3 comps.]",
    "creator_notes": "Generated dynamically by VietRP Charagen AI.",
    "system_prompt": "[CRITICAL RULE] [TYPE A: Act as {{char}} (1st person).] OR [TYPE B: Act as GM (Control world/NPCs, enforce rules). NEVER act for {{user}}.]",
    "post_history_instructions": "[Briefly remind AI of its format rules and role (Character or GM). Max 2 sentences.]",
