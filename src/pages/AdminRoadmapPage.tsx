                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <Badge variant="outline" className="text-[10px] border-green-500/30 text-green-400 py-0 h-5">
                        {planPhases.filter(p => p.status === "done").length}/{planPhases.length} hoàn thành
                      </Badge>
                    </div>
                    <p className="text-[11px] text-muted-foreground">BYOK Chat + Credit System + Role Permissions</p>
                  </div>
                </div>
                <button
